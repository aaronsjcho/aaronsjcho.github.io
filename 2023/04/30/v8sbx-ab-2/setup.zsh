...
git checkout 1bc3cd228ef445429638ebe22f0c59ed5b396ccf # https://github.com/v8/v8/blob/7e9715d8a955214788475dd33a16312ba4d5c3da/DEPS#L226
popd
source ~/.zshrc
...
echo 'solutions = [
  {
    "name": "v8",
    "url": "https://chromium.googlesource.com/v8/v8.git@7e9715d8a955214788475dd33a16312ba4d5c3da",
    "managed": True,
  },
]' >.gclient
gclient sync -Dvvv
